...
?>
	...
	<h1>Our Projects</h1>
		...
		<p class="hook">Microsoft asked students across the world to:</p>

		<blockquote class="hook">Imagine a world where technology helps solve the biggest problems facing us today.</blockquote>

		<p class="hook">And so, we&#8217;ve built a few Mashups using the Microsoft Popfly tool that we hope you find interesting and inspiring. The project is a work in progress and we would really appreciate your feedback if you have the time.</p>
		...
		<br/>
		<p>Want more specifics? Our <a href="http://blog.teamcurious.com">blog</a> follows the development of the project. Also, you can always <a href="contact.php">contact us</a> with specific questions.</p>
